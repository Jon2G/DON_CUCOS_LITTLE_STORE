...
-----Supplier----
GO
CREATE PROCEDURE SP_ABC_SUPPLIERS(@ID INT,@NAME VARCHAR(100),@CELLPHONE VARCHAR(100),@NOTES VARCHAR(MAX),@PICTURE VARCHAR(MAX))
AS
BEGIN
	IF(@ID<=0)
	BEGIN
		INSERT INTO SUPPLIERS(NAME,CELLPHONE,NOTES,PICTURE) VALUES (@NAME,@CELLPHONE,@NOTES,@PICTURE)
	END ELSE
	BEGIN
		UPDATE SUPPLIERS SET NAME=@NAME,CELLPHONE=@CELLPHONE,NOTES=@NOTES,PICTURE=@PICTURE
	END
END;
GO
...
EXEC SP_ABC_SUPPLIERS 0,'SYS','XX-XX-XX-XX-XX','','data:image/jpeg;base64,'
